...
//    private ClusterStorage storage;
    ...
    private List<Cloudlet> libraryStoreinvm = new LinkedList <Cloudlet>();
...
//
//    }
    public void setlibraryStoreinvm(Cloudlet libraryStoreinvm) {
		this.libraryStoreinvm.add(libraryStoreinvm); 
	}
    public final List<Cloudlet> getlibraryStoreinvm(){
    	return this.libraryStoreinvm;
    }
}
