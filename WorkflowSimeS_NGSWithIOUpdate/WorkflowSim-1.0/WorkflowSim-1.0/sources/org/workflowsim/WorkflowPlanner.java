...
public class WorkflowPlanner extends SimEntity {
     ...
     * The workflow parser.
     */
    protected WorkflowESParser parser;
    ...
    public WorkflowPlanner(String name, int schedulers) throws Exception {
     ...
     //   setLibraryList( new ArrayList<Task>());
        ...
        this.parser = new WorkflowESParser(getClusteringEngine().getWorkflowEngine().getSchedulerId(0));
     ...
     */
    public WorkflowESParser getWorkflowESParser() {
    ...
    public void processEvent(SimEvent ev) {
            ...
            case WorkflowSimTags.START_SIMULATION:
            	...
            	getWorkflowESParser().parse();
            	setTaskList(getWorkflowESParser().getTaskList());
            	processPlanning();
	...
	private void processPlanning() {
       ...
       // planner.setLibraryList(getLibraryList());
...
//        ArrayList<Task> exits = new ArrayList();
   ...
   @SuppressWarnings("unchecked")
    ...
    public List<Task> getCopyTaskList() {
    	return (List<Task>) taskList;
    }
