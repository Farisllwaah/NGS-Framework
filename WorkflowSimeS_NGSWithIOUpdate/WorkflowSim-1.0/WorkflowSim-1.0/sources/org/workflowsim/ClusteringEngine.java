...
public final class ClusteringEngine extends SimEntity {
    ...
    protected List< Task> libraryList;
    /**
     * The job list
     */
    ...
    protected List<? extends Task> librarySubmittedList;
    /**
     * The task received list.
     */
    protected List<? extends Task> taskReceivedList;
    protected List<? extends Task> libraryReceivedList;
    /**
    ...
    public ClusteringEngine(String name,int schedulers) throws Exception {
        ...
        setLibrarySubmittedList(new ArrayList<Task>());
        setTaskReceivedList(new ArrayList<>());
        setLibraryReceivedList(new ArrayList<Task>());
...
//    }
    ...
    protected void setLibrarySubmittedList(List<Task> librarySubmittedList) {
    ...
    protected void setLibraryReceivedList(List<Task> libraryReceivedList) {
