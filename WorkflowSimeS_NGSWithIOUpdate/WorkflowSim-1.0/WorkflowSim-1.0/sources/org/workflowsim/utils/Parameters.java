...
public class Parameters {
    ...
    public enum SchedulingAlgorithm {
        ...
        MAXMIN, MINMIN, MCT, DATA, LIBRARY,
        STATIC, FCFS, ROUNDROBIN, INVALID,MCTTPCC,SUPERSIMPLE,
    }
     ...
     * Version number
     */
    //private static ArrayList<String> libList;
   ...
   // public static ArrayList<String> libList= new ArrayList<String>();
    ...
    public static void init(
        ...
        cParams = cp; /** Clustering Parameters **/
        vmNum = vm;
        daxPath = dax;
        runtimePath = runtime;
        datasizePath = datasize;

        oParams = op;  /** Overhead Parameters **/
        schedulingAlgorithm = scheduler;  /** Type of the scheduling algorithm **/
        planningAlgorithm = planner;      /** Type of the planner algorithm **/
