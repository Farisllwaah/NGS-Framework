...
public abstract class BaseSchedulingAlgorithm implements SchedulingAlgorithmInterface {
    ...
    private List<? extends Cloudlet> libraryList;
    ...
    /**
     * the scheduled library list.
     */
    private List< Cloudlet> scheduledlibraryList;
    ...
    @Override
    public List getLibraryScheduledList() {
        return this.scheduledlibraryList;
    }
