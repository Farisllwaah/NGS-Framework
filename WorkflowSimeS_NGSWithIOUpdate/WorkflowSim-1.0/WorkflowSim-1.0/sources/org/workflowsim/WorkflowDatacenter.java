 ...
 */
/*********************************
 * This class has been developed to be able cooperating with our newly
    ...
    protected void processCloudletSubmit(SimEvent ev, boolean ack) {
        ...
        try {
            ...
            if (job.getClassType() == ClassType.COMPUTE.value) {
            	...
            	SharedStorage.processRequest(job,"R" );
             }

            CloudletScheduler scheduler = vm.getCloudletScheduler();
            
            double c1= job.getEndToread()-job.getArrivalToread();
            double estimatedFinishTime = scheduler.cloudletSubmit(job,   c1 );
                ...
                switch (ReplicaCatalog.getFileSystem()) {
                    case SHARED:
                       ...
                       // Storage storage = getStorageList().get(0);
                         ...
                         time += file.getDatasize() / (double) Consts.MILLION / maxRate;
                    ...
                    case LOCAL:
                        ...
                        if (requiredFileStagein && maxBwth > 0.0) {
                        	...
                        	time += file.getDatasize() / Consts.MILLION * 8 / maxBwth;
            ...
            for (Vm vm : host.getVmList()) {
                while (vm.getCloudletScheduler().isFinishedCloudlets()) {
                    ...
                    if (cl != null) {
                    	...
                    	Job c = (Job) cl;
                        try {
                         	SharedStorage.processRequest(c,"W");
					    	} catch (Exception e) {
                       ...
                       // register(cl);
                        schedule("sharedstore", 0.0, CloudSimTags.CLOUDLET_WRITE, cl);
                    }
                }
            }
        }
