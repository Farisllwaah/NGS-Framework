...
public class WorkflowSimTags {
    ...
    /**
     * VM Status is located with library (no library should locate on this vm)
     */
    public static final int VM_STATUS_LIBRARY = BASE + 7;
    /**
    ...
    public static final int LIBRARY_CHECK = BASE + 8;
    public static final int LIBRARY_UPDATE = BASE + 9; 
    public static final int LIBRARY_SUBMIT = BASE + 10;
    public static final int VM_STATUS_BEENUSED = BASE + 11;
    public static final int JOB1_SUBMIT = BASE + 12;
