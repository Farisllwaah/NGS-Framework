...
public class File {
	 ...
	 *             </ul>
	 */
	public File(String fileName, int fileSize, Double Data) throws ParameterException {
	...
	private File makeCopy() {
		File file = null;
		try {
			file = new File(name, attribute.getFileSize(),Datasize);
			FileAttribute fileAttr = file.getFileAttribute();
			attribute.copyValue(fileAttr);
			fileAttr.setMasterCopy(false);   // set this file to replica
		} catch (Exception e) {
...
//	public void setDatasize(Double data) {
//		attribute.setDatasize(data);
//	}
	/**
