...
/**************************************************************************
 * Some of the methods have been added to this class to be compbatible 
 * and cooperating with our newly module SharedStorage, for example, getWaitTowrite(),getWaitToread(),
 * setArrivalToread(double),setArrivalTowrite(double)...etc
 * 
 * @author Faris Llwaah
 * 
 * Date: June 2017
...
public class Cloudlet {
    ...
    private double ArrivalToread;
    private double ArrivalTowrite;
    private double WaitToread;
    private double WaitTowrite; 
    private double StartToread;
    private double StartTowrite;
    private double EndToread;
    private double EndTowrite;
	// //////////////////////////////////////////
	...
	/** The cloudlet is library*/
	public static final int CLOUDLET_IS_LIBRARY =10;
	...
	/** The utilization of library model. */
	private UtilizationModel  utilizationModellibrary;
	...
	private ArrayList<String> requiredLibrary = null;   // Array list of required libraries
	/**
	...
	public Cloudlet(
			...
			final UtilizationModel utilizationModelRam,
			final UtilizationModel utilizationModelBw,
			final UtilizationModel utilizationModellibrary,
			final boolean record) {
		...
		costPerBw = 0.0;
		requiredFiles = new LinkedList<String>();
		requiredLibrary = new ArrayList<String>();
		setUtilizationModelCpu(utilizationModelCpu);
		setUtilizationModelRam(utilizationModelRam);
		setUtilizationModelBw(utilizationModelBw);
		setUtilizationModelBw(utilizationModellibrary);
	}
	/**
	 * Allocates a new Cloudlet object. The Cloudlet length, input and output file sizes should be
	 * greater than or equal to 1. By default this constructor sets the history of this object.
    ...
    */
	...
	public void setCloudletStatus(final int newStatus) throws Exception {
		...
		if (status == Cloudlet.CLOUDLET_IS_LIBRARY) {
			return;
		}
	...
	public static String getStatusString(final int status) {
		...
		switch (status) {
			...
			case Cloudlet.FAILED_RESOURCE_UNAVAILABLE:
				...
				break;
			case Cloudlet.CLOUDLET_IS_LIBRARY:
				statusString = "Cloudlet_is_Library";
				break;	
...
//	}
	 ...
	 * @return the required files
	 */
	public ArrayList<String> getRequiredlibrary() {
	...
	/**
	 * Sets the required library.
	 * 
	 * @param requiredlibrary the new required library
	 */
	
	protected void setRequiredlibrary(final ArrayList<String> requiredlibrary) {
	...
	/**
	 * Gets the utilization model library.
	 * 
	 * @return the utilization model library
	 */
	public UtilizationModel getUtilizationModellibrary() {
		return utilizationModellibrary;
	}
	/**
	 * Sets the utilization model library.
	 * 
	 * @param utilizationModelBw the new utilization model library
	 */
	public void setUtilizationModellibrary(final UtilizationModel utilizationModellibrary) {
		this.utilizationModellibrary = utilizationModellibrary;
	}
	/**
	...
	/**
	 * Gets the utilization of library.
	 * 
	 * @param time the time
	 * @return the utilization of library
	 */
	public double getUtilizationOflibrary(final double time) {
		return getUtilizationModellibrary().getUtilization(time);
	}
	
	public void setArrivalToread(double time){
		this.ArrivalToread=time;
	}
	/** Set The write time of I/O operation */
	public void setArrivalTowrite ( double time){
		this.ArrivalTowrite=time;
	}
	public void setWaitToread(double time){
		this.WaitToread=time;
	}
	/** Set The write time of I/O operation */
	public void setWaitTowrite ( double time){
		this.WaitTowrite=time;
	}
	public void setStartToread(double time){
		this.StartToread=time;
	}
	/** Set The write time of I/O operation */
	public void setStartTowrite ( double time){
		this.StartTowrite=time;
	}
	public void setEndToread(double time){
		this.EndToread=time;
	}
	/** Set The write time of I/O operation */
	public void setEndTowrite ( double time){
		this.EndTowrite=time;
	}
	
	public double getArrivalToread(){
		return this.ArrivalToread;
	}
	/** Set The write time of I/O operation 
	 * @return */
	public double getArrivalTowrite (){
		return this.ArrivalTowrite ;
	}
	public double getWaitToread( ){
		return this.WaitToread ;
	}
	/** Set The write time of I/O operation 
	 * @return */
	public double getWaitTowrite (  ){
		return this.WaitTowrite ;
	}
	public double getStartToread( ){
		return this.StartToread ;
	}
	/** Set The write time of I/O operation 
	 * @return */
	public double getStartTowrite (  ){
		return this.StartTowrite ;
	}
	public double getEndToread( ){
		return this.EndToread ;
	}
	/** Set The write time of I/O operation 
	 * @return */
	public double getEndTowrite ( ){
		 return this.EndTowrite ;
	}
